...
for ceemd_max_step_i in range(7,8):
...
#    nn_input_test1 = nn_input_getting(x_data_input = dust_sig_test1[0:6000],ceemd_max_step = ceemd_max_step_i,white_noise_var=0.3,white_noise_add_num=100,data_analysis_length=6000)
...
#    nn_input_test2 = nn_input_getting(x_data_input = dust_sig_test2[0:6000],ceemd_max_step = ceemd_max_step_i,white_noise_var=0.3,white_noise_add_num=100,data_analysis_length=6000)
...
#    nn_input_test3 = nn_input_getting(x_data_input = dust_sig_test3[0:6000],ceemd_max_step = ceemd_max_step_i,white_noise_var=0.3,white_noise_add_num=100,data_analysis_length=6000)
#    f = open('nn_input_test3.txt', 'a+')
#    f.write(str(nn_input_test3) + os.linesep)
#    f.close()    
#    nn_input_test =   nn_input_test1 + nn_input_test1 +nn_input_test1
...
#    dataset = SupervisedDataSet(len(X[0]),1)
...
#    f = open('test_rlst.txt', 'a+')
#    f.write(format(dataTrain.indim,dataTrain.outdim) + ms.linesep)
#    f.close()
