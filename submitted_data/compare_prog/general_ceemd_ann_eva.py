...
nn_input_test1 = nn_input_getting(x_data_input = dust_sig_test1[:],ceemd_max_step = 7,white_noise_var=0.3,white_noise_add_num=100,data_analysis_length=6000)
...
nn_input_test2 = nn_input_getting(x_data_input = dust_sig_test2[:],ceemd_max_step = 7,white_noise_var=0.3,white_noise_add_num=100,data_analysis_length=6000)
...
nn_input_test3 = nn_input_getting(x_data_input = dust_sig_test3[:],ceemd_max_step = 7,white_noise_var=0.3,white_noise_add_num=100,data_analysis_length=6000)
